...
export const BADGES: Badge[] = [
  {
    ...
    name: 'Eco Warrior',
    nameMs: 'Pejuang Eko',
    description: 'Has sold 50+ pre-loved items',
    emoji: '🌿',
    color: 'var(--green)',
  ...
  },
  {
    ...
    description: 'Active in the circular economy — buying and selling',
    emoji: '♻️',
    color: 'var(--teal)',
  ...
  },
  {
    ...
    description: 'ESG contributor with 100+ transactions',
    emoji: '🏢',
    color: 'var(--purple)',
  ...
  },
  {
    ...
    description: 'Saved over 500kg of CO₂',
    emoji: '🌍',
    color: 'var(--orange)',
