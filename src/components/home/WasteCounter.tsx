    ...
    <section className="py-12 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: 'var(--bg-elevated)' }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-xl font-bold mb-2">Impak Platform Kami</h2>
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
            Bersama kita membina Malaysia yang lebih hijau
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="rounded-2xl p-6 text-center" style={{ backgroundColor: 'var(--bg-card)', border: '1px solid rgba(0,217,165,0.2)' }}>
            ...
            <p className="text-sm font-medium mb-1">CO₂ Diselamatkan</p>
            <p className="text-xs" style={{ color: 'var(--text-secondary)' }}>berbanding membeli baru</p>
          </div>
          ...
          <div className="rounded-2xl p-6 text-center" style={{ backgroundColor: 'var(--bg-card)', border: '1px solid rgba(20,184,166,0.2)' }}>
            ...
            <p className="text-sm font-medium mb-1">Pokok Bersamaan</p>
            <p className="text-xs" style={{ color: 'var(--text-secondary)' }}>CO₂ diserap setiap tahun</p>
          </div>
          ...
          <div className="rounded-2xl p-6 text-center" style={{ backgroundColor: 'var(--bg-card)', border: '1px solid rgba(79,140,255,0.2)' }}>
            ...
            <p className="text-sm font-medium mb-1">Air Dijimatkan</p>
            <p className="text-xs" style={{ color: 'var(--text-secondary)' }}>daripada pengeluaran baharu</p>
          </div>
        </div>
      </div>
    </section>
