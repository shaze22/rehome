...
import { Zap, ArrowLeftRight, ArrowRight, Clock, DollarSign, Package, CheckCircle } from 'lucide-react'

export function HeroBanner() {
  return (
    <section className="relative overflow-hidden px-4 sm:px-6 lg:px-8 pt-12 pb-8">
      {/* Background glow */}
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="text-center mb-8">
          <p className="text-xs font-semibold tracking-widest uppercase mb-3" style={{ color: 'var(--text-muted)' }}>
            Malaysia&apos;s Circular Economy Marketplace
          </p>
          ...
          <p className="mt-3 text-sm sm:text-base max-w-xl mx-auto" style={{ color: 'var(--text-secondary)' }}>
            Pick your mode. Every deal is secure, escrow-protected, and IC-verified.
          </p>
        </div>
